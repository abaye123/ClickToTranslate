...
namespace ClickToTranslate
{
    ...
    public static class SettingsManager
    {
        ...
        public static void Save(AppSettings settings)
        {
            ...
            {
                System.Windows.MessageBox.Show($"שגיאה בשמירת ההגדרות: {ex.Message}",
                    "ClickToTranslate", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
            }
        }
    }
}
